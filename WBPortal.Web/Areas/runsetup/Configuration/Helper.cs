...
namespace WhiteBrandShrink.Helper
{
    public class Helper
    {
        /// <summary>
        ...
        public static IEnumerable<string> GetDirectoriesWrite()
        {
            ...
            string rootDir = HttpContext.Current.Request.MapPath("~/");
        ...
        public static IEnumerable<string> GetFilesWrite()
        {
            ...
            filesToCheck.Add(Path.Combine(rootDir, "App_Data\\siteconfiguration.xml"));
            return filesToCheck;
        }
