<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT'] .'\\upload\\'. str_replace('.', '', str_replace('www.', '',$_SERVER['SERVER_NAME'])) .'\\upload-files'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'] .'\\upload\\'. str_replace('.', '', str_replace('www.', '',$_SERVER['SERVER_NAME'])) .'\\upload-files'; // absolute or relative from this script path, required.
