...
public class AdoHelper : IDisposable
{
    ...
    /// </summary>
    public static string ConnectionString { get { return System.Configuration.ConfigurationManager.ConnectionStrings["WhiteLabelConnection"].ConnectionString; } }
    ...
    public SqlCommand CreateCommand(string qry, bool isProc)
    {
    ...
    public int ExecNonQuery(SqlCommand cmd,bool isProc)
    {
        cmd.CommandType = isProc ? CommandType.StoredProcedure : CommandType.Text;
    ...
    public object ExecScalar(SqlCommand cmd, bool isProc)
    {
        cmd.CommandType = isProc ? CommandType.StoredProcedure : CommandType.Text;
        cmd.Connection = _conn;
        // Associate with current transaction, if any
    ...
    public SqlDataReader ExecDataReader(SqlCommand cmd, bool isProc)
    {
        cmd.CommandType = isProc ? CommandType.StoredProcedure : CommandType.Text;
        cmd.Connection = _conn;
        // Associate with current transaction, if any
